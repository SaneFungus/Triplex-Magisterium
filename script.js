document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.checkbox-group label input[name="fire"]').forEach(input => {
    ...
    function generatePrompt() {
        ...
        switch (activeForma) {
            case 'separatio':
                const fireCheckboxes = document.querySelectorAll('.parameter-group[data-forma="separatio"] input[name="fire"]:checked');
                const fires = Array.from(fireCheckboxes).map(checkbox => checkbox.value);
            ...
            case 'coagulatio':
                const temporalScope = document.querySelector('input[name="temporal-scope"]:checked').value;
            ...
            case 'coniunctio':
                ...
                const synthesisTypes = document.querySelectorAll('.parameter-group[data-forma="coniunctio"] input[name="synthesis"]:checked');
                const syntheses = Array.from(synthesisTypes).map(checkbox => checkbox.value);
