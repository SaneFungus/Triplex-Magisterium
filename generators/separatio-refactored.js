/**
 * SeparatioGenerator - Generator typu Separatio (Nigredo/Albedo)
 *
 * Odpowiada za analityczny rozkład problemu na fundamentalne elementy.
 * Wykorzystuje nową klasę bazową Generator.
 */
import { Generator } from "../core/generator-base.js"

export class SeparatioGenerator extends Generator {
  /**
   * Konstruktor generatora Separatio
   */
  constructor() {
    super({
      id: "separatio",
